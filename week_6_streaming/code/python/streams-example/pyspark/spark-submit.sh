...
spark-submit --master spark://localhost:7077 --num-executors 2 \
    ...
    --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.0,org.apache.spark:spark-avro_2.12:3.5.0,org.apache.spark:spark-streaming-kafka-0-10_2.12:3.5.0 \
	$PYTHON_JOB